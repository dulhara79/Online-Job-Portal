...
<link href="http://localhost/Online-Job-Portal/php/feedback/style.css" rel="stylesheet" type="text/css" media="all" />
	  ...
	  <h3>Please help us to serve you better by taking a couple of minutes. </h3>
	    <form action="feedback.php" method="post" class="agile_form">
		  <h2>How satisfied were you with our Service?</h2>
			...
			<a href="http://localhost/Online-Job-Portal/php/feedback/view_feedback.php"> <button type="button">View Feedbacks</button> </a>
